  ...
  return (
    <ThemedView className="flex-1">
      ...
      <ParallaxScrollView
        ...
        headerImage={
          <Image source={{ uri: productData.image }} style={styles.reactLogo} />
        }
      >
        ...
        <ThemedView className="">
          ...
          {reviews.map((review) => (
            <>
              <ThemedView className="flex-row rounded-lg p-4" key={review.id}>
                <Image
                ...
                <ThemedView className="ml-4 flex-1">
                  ...
                  <Text className="text-gray-500 text-xs">{review.time}</Text>
                  <Text className="text-sm mt-2">{review.review}</Text>
                </ThemedView>
              </ThemedView>
